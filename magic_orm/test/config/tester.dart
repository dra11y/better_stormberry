import 'package:magic_orm/src/cli/migration/differentiator.dart';
import 'package:magic_orm/src/cli/migration/patcher.dart';
import 'package:magic_orm/src/cli/migration/schema.dart';
...
extension SchemaChanger on PgDatabase {
  Future<DatabaseSchemaDiff> migrateTo(String glob, {bool log = true}) async {
    var schema = await DatabaseSchema.load(
      '.dart_tool/build/generated/magic_orm/test/$glob.schema.json',
    );
